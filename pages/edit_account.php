        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                <div class="navbar-header">
                    <label class="navbar-brand">todo+</label>
                </div>
                <ul class="nav navbar-nav">
                    <li class="active"><a href="index.php?page=tasks&action=all">Home</a></li>
                    <li><a href="index.php?page=tasks&action=create">Create TODO</a></li>
                    <li><a href="index.php?page=accounts&action=show&id=<?php echo $record->id ?>">Profile</a></li>
            ...
            <div id="loginbox" class="mainbox col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3"> 
                ...
                <div class="panel panel-default" >
                    <div class="panel-heading">
                        <div class="panel-title text-center">Update Account Details</div>
                    </div>     

                    <div class="panel-body" >

                        <form name="form" id="form" class="form-horizontal" enctype="multipart/form-data" action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon "></i></span>
                                <input id="user" type="text" class="form-control" name="fname" value="" placeholder="First Name">                                        
                            </div>

                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon"></i></span>
                                <input id="user" type="text" class="form-control" name="lname" value="" placeholder="Last Name">                                        
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12 controls">
                                    <button name="update" type="submit" class="btn btn-primary btn-lg btn-block"><i class="glyphicon "></i>Update</button>                          
                                </div>
                            </div>
